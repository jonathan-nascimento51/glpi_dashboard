...
async def get_v2_kpis() -> Dict[str, Any]:
    ...
    try:
        ...
        kpis_data = {
            "total_tickets": {"value": 150, "trend": "+5%", "previous_period": 143},
            "open_tickets": {"value": 45, "trend": "-2%", "previous_period": 46},
            "resolved_tickets": {"value": 105, "trend": "+8%", "previous_period": 97},
            "avg_resolution_time": {
                "value": 2.5,
                "unit": "hours",
                "trend": "-10%",
        ...
        return {
            ...
            "version": "v2",
            "data": kpis_data,
            "metadata": {"last_updated": "2024-01-15T10:30:00Z", "cache_ttl": 300},
        }
