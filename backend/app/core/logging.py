# -*- coding: utf-8 -*-
"""
Configura��o de logging estruturado para o GLPI Dashboard.
"""
...
def get_logging_config(log_level: str = "INFO", log_file: str = None) -> Dict[str, Any]:
    """
    Retorna configura��o de logging estruturado.
    ...
    Returns:
        Dicion�rio de configura��o para logging.config.dictConfig
    """
...
# Configura��es espec�ficas para diferentes ambientes
class LoggingConfig:
    """Configura��es de logging para diferentes ambientes."""
    ...
    @staticmethod
    def testing():
        """Configura��o para ambiente de testes."""
        return {
            "log_level": "WARNING",
            "log_file": None,
            "console_output": True
...
# Configura��es para integra��o com servi�os de monitoramento
class MonitoringIntegration:
    ...
    def elk_stack_config():
        """
        Configura��o para integra��o com ELK Stack (Elasticsearch, Logstash, Kibana).
        
        Returns:
            Dicion�rio com configura��es recomendadas
        """
        return {
            "log_format": "json",
            "fields": {
    ...
    def grafana_loki_config():
        """
        Configura��o para integra��o com Grafana Loki.
    ...
    def prometheus_config():
        """
        Configura��o para m�tricas do Prometheus.
        
        Returns:
            Dicion�rio com configura��es de m�tricas
        """
        return {
            "metrics": {
                "api_calls_total": {
