...
from models.validation import TechnicianRanking, Ticket, SystemStatus
...
def get_system_status():
    return {"status": "operational", "uptime": "99.9%", "version": "1.1.0"}


@app.get(
    "/v1/technicians/ranking",
    response_model=List[TechnicianRanking],
    tags=["technicians"],
)
