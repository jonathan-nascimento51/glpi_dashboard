...
def get_kpis():
    ...
    logger.business_event("kpis_requested", version="v1", endpoint="/v1/kpis")
...
def get_business_metrics():
    ...
    logger.business_event("business_metrics_requested", endpoint="/v1/metrics")
    ...
    try:
        ...
        logger.info("Business metrics retrieved successfully", **metrics)
...
def get_kpis_v2():
    ...
    logger.business_event("kpis_requested", version="v2", endpoint="/v2/kpis")

    # Verificar feature flag
    if not flags.is_enabled("use_v2_kpis"):
        logger.warning("v2 KPIs endpoint disabled by feature flag", flag="use_v2_kpis")
        raise BusinessError(
...
def test_validation_error():
    ...
    raise ValidationError(
        field="level", message="deve ser um dos valores: N1, N2, N3, N4", value="N5"
    )
