...
class LevelMetrics(BaseModel):
    """Metricas de um nivel especifico (N1, N2, N3, N4)"""
    novos: int = Field(ge=0, description="Numero de tickets novos")
    pendentes: int = Field(ge=0, description="Numero de tickets pendentes")
    progresso: int = Field(ge=0, description="Numero de tickets em progresso")
    resolvidos: int = Field(ge=0, description="Numero de tickets resolvidos")

class NiveisMetrics(BaseModel):
    """Metricas de todos os niveis"""
    n1: LevelMetrics
    n2: LevelMetrics
    n3: LevelMetrics
    n4: LevelMetrics
...
class DashboardMetrics(BaseModel):
    """Schema unificado para metricas do dashboard"""
...
class ApiResponse(BaseModel):
    """Schema padrao para respostas da API"""
    success: bool = True
    data: Any
