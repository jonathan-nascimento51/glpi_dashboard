...
class ResponseFormatter:
    """Utilit�rio para formata��o unificada das respostas da API"""
    
    @staticmethod
    def format_dashboard_response(raw_metrics: Dict, filters: Optional[Dict] = None, 
                                start_time: Optional[float] = None) -> Dict[str, Any]:
        """Formata resposta das m�tricas do dashboard de forma unificada"""
        try:
            # Calcular tempo de execu��o se fornecido
            execution_time = None
            if start_time:
            ...
            # Se h� estrutura by_level (com filtros)
            if raw_metrics and 'by_level' in raw_metrics:
                for level_name, level_data in raw_metrics['by_level'].items():
                    ...
                    niveis_data[level_key] = {
                        ...
                        'progresso': (
                            level_data.get('Processando (atribu�do)', 0) + 
            ...
            # Se h� estrutura niveis (sem filtros)
            ...
            # Garantir que todos os n�veis existam
            ...
            if raw_metrics and 'general' in raw_metrics:
                ...
                progresso = (
                    general.get('Processando (atribu�do)', 0) + 
                ...
                # Sem filtros - calcular dos n�veis
            ...
            # Adicionar totais gerais aos n�veis
            niveis_data['geral'] = {
                'novos': novos,
                'pendentes': pendentes,
                'progresso': progresso,
            ...
            return ResponseFormatter.format_error_response(
                message="Erro ao formatar m�tricas do dashboard",
                errors=[str(e)]
            )
    ...
    @staticmethod
    def format_success_response(data: Any, message: str = "Opera��o realizada com sucesso") -> Dict[str, Any]:
