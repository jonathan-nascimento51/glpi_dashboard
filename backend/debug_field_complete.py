...
def main():
    ...
    try:
        ...
        # Procurar campo 95 especificamente
        field_95 = search_options.get('95')
        if field_95:
            print(f'\nCampo 95 encontrado:')
            print(f'Nome: {field_95.get("name", "N/A")}')
            print(f'Tabela: {field_95.get("table", "N/A")}')
            print(f'Campo: {field_95.get("field", "N/A")}')
            print(f'Tipo: {field_95.get("datatype", "N/A")}')
        else:
            print('\nCampo 95 não encontrado!')
        ...
        print(f'Erro ao buscar opções de pesquisa: {e}')
        import traceback
        traceback.print_exc()
