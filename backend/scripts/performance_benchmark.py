...
class PerformanceBenchmark:
    ...
    def run_metrics_comparison(self) -> None:
        ...
        legacy_results = self.benchmark_endpoint(
            "demo/metrics/legacy",
            test_params,
            "Legacy Architecture Demo (/api/demo/metrics/legacy)"
        )
        ...
        new_results = self.benchmark_endpoint(
            "demo/metrics/new",
            test_params,
            "New Architecture Demo (/api/demo/metrics/new)"
        )
    ...
    def run_comprehensive_benchmark(self) -> None:
        ...
        test_cases = [
            ...
            {
                "endpoint": "demo/technicians/ranking/legacy",
                "params": {"limit": 50},
                "name": "Legacy Technician Ranking"
            },
            {
                "endpoint": "demo/technicians/ranking/new",
                "params": {"limit": 50},
                "name": "New Technician Ranking"
            },
            {
    ...
    def _calculate_comparison(self, legacy: Dict, new: Dict) -> None:
        ...
        comparison = {
            "response_time_improvement": {
                ...
                "improvement_percent": ((legacy["response_time"]["mean_ms"] - new["response_time"]["mean_ms"]) / legacy["response_time"]["mean_ms"]) * 100,
            ...
            "throughput_comparison": {
                ...
                "throughput_improvement_percent": ((new["throughput_rps"] - legacy["throughput_rps"]) / legacy["throughput_rps"]) * 100 if legacy["throughput_rps"] > 0 else 0
            }
        }
    ...
    def print_results(self) -> None:
        ...
        for category, endpoints in [("Legacy Results", self.results.get("legacy_results", {})),
