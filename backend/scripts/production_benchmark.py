...
class ProductionBenchmark:
    ...
    def single_thread_benchmark(self, endpoint: str, params: Optional[Dict] = None, 
                              iterations: int = 20, name: str = "") -> Dict[str, Any]:
        ...
        analysis = {
            ...
            "server_metrics": {
                ...
                "memory_delta_mb": self._safe_subtract(
                    end_server_metrics, start_server_metrics, 
                    ["memory", "current_rss_mb"]
                ),
    ...
    def concurrent_benchmark(self, endpoint: str, params: Optional[Dict] = None,
                           concurrency: int = 10, duration_seconds: int = 30, name: str = "") -> Dict[str, Any]:
        ...
        analysis = {
            ...
            "server_metrics": {
                ...
                "end": end_server_metrics,
                "memory_delta_mb": self._safe_subtract(
                    end_server_metrics, actual_start_metrics,
                    ["memory", "current_rss_mb"]
                ),
    ...
    def run_comprehensive_benchmark(self):
        ...
        legacy_single = self.single_thread_benchmark(
            "demo/metrics/legacy", test_params, 25,
            "Legacy Architecture (Single-thread)"
        )
        self.results["legacy_results"]["single_thread"] = legacy_single
        
        time.sleep(1)  # Brief pause between tests
        
        new_single = self.single_thread_benchmark(
            "demo/metrics/new", test_params, 25,
            "New Architecture (Single-thread)"
        )
        ...
        legacy_concurrent = self.concurrent_benchmark(
            "demo/metrics/legacy", test_params, 8, 20,
            "Legacy Architecture (Concurrent)"
        )
        self.results["legacy_results"]["concurrent"] = legacy_concurrent
        
        time.sleep(2)  # Pause between concurrent tests
        
        new_concurrent = self.concurrent_benchmark(
            "demo/metrics/new", test_params, 8, 20,
    ...
    def print_results(self):
        ...
        for category, tests in [("Legacy", self.results.get("legacy_results", {})),
