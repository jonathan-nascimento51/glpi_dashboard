...
class GLPIService:
    ...
    def _perform_authentication(self) -> bool:
        ...
        try:
            ...
            response = requests.get(f"{self.glpi_url}/initSession", headers=session_headers, timeout=10)
    ...
    def get_dashboard_metrics(self, start_date: Optional[str] = None, end_date: Optional[str] = None) -> Dict[str, any]:
        ...
        try:
            ...
            general_progresso = general_totals.get("Processando (atribuído)", 0) + general_totals.get(
            ...
            for level_name, level_data in raw_metrics.items():
                ...
                if level_key in level_metrics:
                    ...
                    level_metrics[level_key]["progresso"] = level_data.get("Processando (atribuído)", 0) + level_data.get(
                        "Processando (planejado)", 0
                    )
    ...
    def _get_technician_ranking_knowledge_base(self) -> list:
        ...
        try:
            ...
            response = self._make_authenticated_request("GET", f"{self.glpi_url}/search/Profile_User", params=profile_params)
    ...
    def _list_active_technicians_fallback(self) -> list:
        ...
        try:
            ...
            response = self._make_authenticated_request("GET", f"{self.glpi_url}/Profile_User", params=params)
    ...
    def get_technician_ranking_with_filters(
        ...
        try:
            ...
            for tech in technicians:
                ...
                ticket_count = self._count_tickets_with_date_filter(tech_id, start_date, end_date)
