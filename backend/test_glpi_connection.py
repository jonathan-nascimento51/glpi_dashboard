            ...
            if response.status_code == 200:
                ...
                if search_data.get('data'):
                    ...
                    for i, user in enumerate(search_data.get('data', [])[:3]):
                        print(f"  {i+1}. ID: {user.get('2')}, Username: {user.get('1')}, Nome: {user.get('9')} {user.get('34')}")
                else:
            ...
            if response.status_code == 200:
                ...
                if search_data.get('data'):
                    ...
                    for i, profile in enumerate(search_data.get('data', [])[:3]):
                        print(f"  {i+1}. ID: {profile.get('2')}, User ID: {profile.get('3')}, Profile ID: {profile.get('4')}, Entity ID: {profile.get('5')}")
                else:
