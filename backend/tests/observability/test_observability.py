...
class TestMetricsMiddleware:
    ...
    def test_middleware_initialization(self):
        ...
        assert middleware.exclude_paths == ["/metrics", "/health", "/docs", "/openapi.json"]
    ...
    async def test_successful_request_metrics(self):
        ...
        with patch('observability.middleware.REQUEST_COUNT') as mock_counter, \
             patch('observability.middleware.REQUEST_DURATION') as mock_duration, \
             patch('observability.middleware.REQUEST_SIZE') as mock_req_size, \
             patch('observability.middleware.RESPONSE_SIZE') as mock_resp_size, \
             patch('observability.middleware.logger'):
...
class TestExceptionHandlers:
    ...
    def test_setup_exception_handlers(self, mock_fastapi):
        ...
        call_args = [call[0][0] for call in mock_app.add_exception_handler.call_args_list]
