...
class TestGLPIServiceRanking:
    ...
    def glpi_service(self):
        ...
        with patch("services.glpi_service.GLPIService._authenticate_with_retry"):
            service = GLPIService()
    ...
    @patch("services.glpi_service.GLPIService._ensure_authenticated")
    @patch("services.glpi_service.GLPIService._make_authenticated_request")
    def test_get_technician_ranking_with_filters_success(
        self,
        mock_request,
        mock_ensure_auth,
        mock_auth,
        glpi_service,
        mock_technicians_response,
        ...
        def mock_request_side_effect(*args, **kwargs):
            ...
            # Busca de tickets
                ...
                if user_id == "10":
                    return Mock(
                        ok=True,
                        json=lambda: mock_tickets_response,
                        headers={"Content-Range": "items 0-4/5"},
                    )
                elif user_id == "20":
                    return Mock(
                        ok=True,
                        json=lambda: {"data": [mock_tickets_response["data"][2]]},
                        headers={"Content-Range": "items 0-0/1"},
                    )
                elif user_id == "30":
                    return Mock(
                        ok=True,
                        json=lambda: {"data": mock_tickets_response["data"][3:6]},
        ...
        result = glpi_service.get_technician_ranking_with_filters(
            start_date="2025-01-01", end_date="2025-12-31", level=None, limit=10
        )
    ...
    def test_get_technician_ranking_with_filters_no_technicians(self, mock_get, mock_auth, glpi_service):
        ...
        result = glpi_service.get_technician_ranking_with_filters(start_date="2025-01-01", end_date="2025-12-31")
    ...
    @patch("services.glpi_service.GLPIService._authenticate_with_retry")
    @patch("services.glpi_service.requests.get")
    def test_get_technician_ranking_with_filters_with_level_filter(
        self,
        mock_get,
        mock_auth,
        glpi_service,
        ...
        result = glpi_service.get_technician_ranking_with_filters(
            start_date="2025-01-01", end_date="2025-12-31", level="Sênior", limit=5
        )
    ...
    @patch("services.glpi_service.GLPIService._authenticate_with_retry")
    @patch("services.glpi_service.requests.get")
    def test_get_technician_ranking_with_filters_with_limit(
        self,
        mock_get,
        mock_auth,
        glpi_service,
        ...
        result = glpi_service.get_technician_ranking_with_filters(start_date="2025-01-01", end_date="2025-12-31", limit=2)
...
@patch("services.glpi_service.requests.get")
    def test_get_technician_ranking_with_filters_invalid_dates(self, mock_get, mock_auth, glpi_service):
        ...
        result = glpi_service.get_technician_ranking_with_filters(start_date="2025-12-31", end_date="2025-01-01")
