...
# Redirecionar stderr para evitar logs do sistema
...
def main():
    print("=== Debug Profile_User (Limpo) ===")
    ...
    test_profile_user_search(glpi_service, "Todos os Profile_User (primeiros 5)", params1)
    ...
    # Teste 4: Buscar com perfil 6 E entidade 2
    params4 = {
        "criteria[0][field]": "4",  # profiles_id
        "criteria[0][searchtype]": "equals",
        "criteria[0][value]": "6",
    ...
    test_profile_user_search(glpi_service, "Profile_User com perfil 6 E entidade 2", params4)
    
    # Teste 5: Verificar estrutura de um registro
    print("\n=== Verificando estrutura de um registro ===")
    params5 = {
        "range": "0-1"
    }
    response = glpi_service._make_authenticated_request(
