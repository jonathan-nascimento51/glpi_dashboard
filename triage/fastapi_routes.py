...
async def get_metrics() -> Dict[str, Any]:
    """Endpoint para obter metricas do dashboard"""
    try:
        # Mock data para healthcheck - substitua pela lógica real
        metrics_data = {
            "total": 150,
            "open": 45,
            "closed": 105,
        ...
        return {
            "success": True,
            "data": metrics_data,
            **metrics_data  # Também incluir no nível raiz para compatibilidade
        }
    except Exception as e:
